...
class Comments extends Component {
  ...
  onDeleteUpdateList = id => {
    ...
    const modifiedList = CommentDetails.filter(eachCom => eachCom.id !== id)

    this.setState(preState => ({
      CommentDetails: modifiedList,
      commentsCount: preState.commentsCount - 1,
    }))
  }
        ...
        <div className="main-sub-div">
          ...
          <ul className="ul-div">
            {CommentDetails.map(eachComment => (
              <CommentItem
                onIsLike={this.onIsLike}
                onDeleteUpdateList={this.onDeleteUpdateList}
